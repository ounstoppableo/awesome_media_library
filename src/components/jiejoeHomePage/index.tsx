      ...
      <div className="w-full h-[100dvh] flex items-center ">
        <div className="h-full w-2/5 flex flex-col justify-center gap-[10%] py-[10%] pl-[10%] brightness-120">
          ...
          <div className="text-[2.5vmin] text-white">
            ...
            iusto quaerat qui, illo incidunt suscipit fugiat distinctio officia
            earum eius quae officiis quis harum animi. Lorem, ipsum dolor sit
            amet consectetur adipisicing elit. Dolor iusto quaerat qui, illo
            incidunt suscipit fugiat distinctio officia earum eius quae officiis
            quis harum animi.
          </div>
